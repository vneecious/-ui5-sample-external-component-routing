		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#myroutingexternalcomponent-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"myroutingexternalcomponent-display": {
								"semanticObject": "myroutingexternalcomponent",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=my.routingexternalcomponent",
									"url": sap.ui.require.toUrl("my/routingexternalcomponent")
								}
							}
						}
					}
